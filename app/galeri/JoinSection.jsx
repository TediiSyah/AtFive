  ...
  return (
    <section ref={sectionRef} className={styles.container} style={{ marginBottom: '150px' }}>
      ...
      <h2 ref={headingRef} className={styles.heading} style={{ opacity: 0, transition: 'all 0.5s ease-out' }}>
        Yuk, Jadi {" "}
        <span className={styles.red}>Bagian </span> Dari Cerita <span className={styles.red}>Berikutnya</span>
      </h2>
      <a href="/tentangKami"><p className={styles.subtext}> Lihat Lebih Banyak Momen Kami →
</p></a>
