...
export default function HeroSection() {
  ...
  return (
    <section 
      ref={ref}
      className="relative flex flex-col items-center justify-center min-h-[150vh] bg-gradient-to-br from-red-50 to-red-100 overflow-hidden text-center px-4"
    >
      ...
      <div className="sticky top-0 h-screen flex items-center justify-center w-full">
        ...
        >
          ...
          <motion.h1 
            ...
            style={{ y: y3 }}
          >
            Still confused about choosing <br className="hidden sm:block" />
            <span className="bg-gradient-to-r from-red-700 to-red-800 bg-clip-text text-transparent drop-shadow-md">
              the right major?
            </span>
          </motion.h1>
          ...
          <div className="relative">
            ...
            >
              Don't worry! Find the answer together with us.
            </motion.p>
