...
Pesebaran <span className="text-red-700">Alumni</span> </h1> <p className="text-center text-gray-600 mb-8 text-base md:text-lg">
Daftar Persebaran Alumni Terbaik Kami</p>
      ...
      <table className="w-full border-collapse shadow-md">
        <thead>
          <tr className="bg-red-700 text-white">
            ...
            <th className="border border-gray-800 p-3 font-semibold text-center">Perusahaan</th>
          ...
          <div className="flex items-center justify-between mb-3 pb-3 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 text-center">Perusahaan {item.perusahaan}</p>
              </div>
            </div>
