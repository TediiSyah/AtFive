...
const StatisticSection = () => {
  ...
  return (
    ...
    >
      <div>
        <Counter target={90} label="IT Field" visible={visible} />
        <div className={styles.divider}></div>
        <Counter target={7} label="Entrepreneur" visible={visible} />
        <div className={styles.divider}></div>
        <Counter target={3} label="Non IT Field" visible={visible} />
      </div>
    </section>
  );
};
